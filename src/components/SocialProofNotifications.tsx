...
const notifications: Omit<Notification, "id">[] = [
  ...
  { name: "Maria Silva", city: "Imperatriz", state: "MA", action: "pagamento confirmado via Pix, garantiu o acesso mensal 🎉" },
  ...
  { name: "Beatriz Alves", city: "Pedreiras", state: "MA", action: "Pix confirmado! Acesso mensal garantido 🎉" },
